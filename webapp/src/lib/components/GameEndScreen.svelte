...
<div class="h-screen w-screen bg-black bg-opacity-25 absolute">
		...
		<div class="flex flex-col items-center">
			{#if winner !== null}
				<img
					...
					class="w-[9rem] z-50 drop-shadow-bold rotate-[-3deg]"
				/>
			{/if}
			<div
				class="w-[30rem] h-[20rem] bg-purple drop-shadow-bold -translate-y-[5rem] flex flex-col justify-center items-center"
			>
